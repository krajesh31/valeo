...
import wir from '../img/Packagingoption.jpg'
...
function Energy() {
 ...
 <Carousel autoPlay infiniteLoop  className="def-cal "  >
  ...
  <div className="col-xxl-4 col-xl-4 col-md-4 plugin-p my-4" >
    <p>Multi-tier shelving is the construction of shelving at two or more levels using the same components used for selective pallet racking or heavy duty shelving. Multi-tier Shelving is suitable for medium to large size warehouses. It is ideal for storage and distribution of large small parts SKUs.</p>
  </div>
