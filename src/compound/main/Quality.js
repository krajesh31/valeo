  ...
  return (
    ...
    <img alt="" src={Pv5} />
        ...
        <div className="col-xxl-4 col-xl-4 col-md-4 plugin-p my-4" >
          <p>Mobile storage systems (Compactors) are moveable filing cabinets mounted on a track way. These specialized office furniture units are usually constructed with a rotary handle on the exterior accessible face. When revolved, the handle operates the mechanism which winds the single, connected, filing unit either left or right, depending on a clockwise or counter clockwise rotation of the handle.</p>
        </div>
